...
async function generateMermaidName() {
  ...
  resultBox.innerHTML =
    '<div class="loading-bubbles"><span></span><span></span><span></span></div><p style="margin-top:5px; font-size:0.9rem; color:#666;">Consultando as conchas mágicas...</p>';
...
function createBubbles() {
  ...
  for (let i = 0; i < bubbleCount; i++) {
    ...
    bubble.style.left =
      Math.random() * 95 +
      "vw"; /* Alterado de 100vw para 95vw para evitar overflow */
